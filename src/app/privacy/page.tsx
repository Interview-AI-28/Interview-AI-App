        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    ['Spoken interview answers (live speech-to-text transcripts — no audio is recorded or stored)', 'Captured during live interview sessions', 'Evaluate your answers in real time; generate your feedback report; identify topics to practise. We automatically strip email addresses, phone numbers, and URLs from transcripts before storage or AI processing.'],
                    ['Job description, company name, role, years of experience', 'Entered by you during interview setup', 'Generate role-specific interview questions tailored to the target job. Job description text is scrubbed of email addresses, phone numbers, and URLs before storage or AI processing.'],
                    ['Resume / CV text', 'Optionally uploaded or pasted by you', 'Personalise questions to your actual projects and experience. Before use, we automatically strip email addresses, phone numbers, and URLs from the text. Resume text is never stored in our database — it is processed in memory during question generation and then discarded.'],
                    ['AI coach chat messages', 'Typed by you when chatting with the post-interview AI coach', 'Answer your follow-up questions about your performance. Scrubbed of email addresses, phone numbers, and URLs before being sent to our AI provider. Not persisted after your session ends.'],
                    ...
                    ['Device fingerprint', 'Generated client-side by FingerprintJS (open-source, no external lookup) on your first dashboard visit', 'A soft anti-abuse signal to help detect duplicate accounts. Deleted when you delete your account.'],
          ...
          <section>
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-200">
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ['Anthropic (Claude)', 'Generate interview questions, evaluate answers, and power the post-interview AI coach chat', 'JD text, resume text (transient), interview transcripts, company/role, coach chat messages', 'anthropic.com/privacy'],
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>After account deletion — what is deleted:</strong> Your name, email address, profile photo, interview transcripts, feedback reports, session history, focus area analysis, referral relationships, push notification tokens, and device fingerprint are permanently deleted immediately (no more than 30 days) upon your request.</li>
          ...
          <section>
            ...
            <p>
              ...
              <code className="bg-gray-100 px-1 rounded text-xs">intervizly.com/report/abc123</code>).
                  ...
                  {title === 'Right to Erasure ("Delete My Account")' ? (
                    <div className="text-xs text-gray-600 space-y-1.5">
                      <p>
                        ...
                        area analysis, referral relationships, push notification tokens, and device
                        fingerprint.
                      </p>
                      <p>
