              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    ['Spoken interview answers (audio transcripts)', 'Captured during live interview sessions', 'Evaluate your answers in real time; generate your feedback report; identify topics to practise. We automatically strip email addresses, phone numbers, and URLs from transcripts before storage or AI processing.'],
