...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using the Intervizly platform.',
}
...
const SECTIONS = [
  {
    ...
    content: (
      <>
        <p>
          By accessing or using Intervizly (the &quot;Platform&quot;),
          ...
          (&quot;Intervizly&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), based in India.
        </p>
        <p className="mt-2">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-2">
          <strong>Geographic availability:</strong> Intervizly is currently available
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Intervizly provides an AI-powered mock interview platform that allows users to
        ...
        <p className="mt-2">
          <strong>Intervizly is not a recruitment agency</strong> and does not guarantee
    ...
    content: (
      <>
        <p>
          ...
          Content, you grant Intervizly a limited, worldwide, royalty-free licence to process
        ...
        <p className="mt-2">
          ...
          feedback reports, and all associated intellectual property — is owned by Intervizly
    ...
    content: (
      <>
        <p>
          ...
          would assess you</strong>, and you should not rely solely on Intervizly feedback when
  ...
  },
  {
    ...
    content: (
      <>
        <p className="uppercase tracking-wide text-xs">
          To the maximum extent permitted by applicable law, Intervizly shall not be liable
  ...
  },
  {
    ...
    content: (
      <p>
        You agree to indemnify and hold harmless Intervizly and its officers, directors,
